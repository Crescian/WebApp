...
<div class="container-fluid">
    <div class="row">
        <div class="col content overflow-auto p-4 d-md-block" style="max-height: 100vh;">
            <!-- content section -->
            <div class="row">
                <span class="page-title-physical" style="font-weight: lighter;">Daily Room Inspection Checklist</span>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="card shadow">
                        <div class="card-header card-2 py-3">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h4 class="fw-bold text-light" style="font-weight: lighter;">Daily Room Inspection</h4>
                                </div>
                                <div class="col-sm">
                                    <div class="row">
...
<script>
    ...
    function loadDailyRoomTable() {
        var daily_room_table = $('#daily_room_table').DataTable({
            ...
            'deferRender': true,
            'ajax': {
                url: '../controller/phd_controller/phd_daily_room_inspection_contr.class.php',
                type: 'POST',
                dataType: 'JSON',
                data: {
            ...
            success: function(result) {
                ...
                $.each(result, function(index, row) {
                    ...
                    $.each(row, function(key, details) {
                        ...
                        html += '<input type="hidden" name="dr_category_name[]" class="form-control fw-bold text-uppercase dr_category_name" value="' + details.category_name + '" disabled></td>';
                        ...
                        html += '<select class="form-select fw-bold aircon aircon' + count + '" onchange="status_change(this.value);" disabled>';
                ...
                $.each(result, function(index, row) {
                    ...
                    $.each(row, function(key, details) {
                        ...
                        if (details.dr_prepared != null) {
                            html += '<td><input type="hidden" class="btnActivate' + count + ' form-control btnActivateValue" value="' + active2 + '" disabled><button type="button" class="btn btn-secondary btn-sm col-sm-12 fw-bold btnActivate" value="' + count + '" id="btnActivate' + count + '" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Scan QR Code" disabled>' + active.replace(':', ''); + '</button></td>';
                        } else {
                        ...
                        html += '<td style="vertical-align: middle; text-align: center;">';
                        html += '<select class="form-select fw-bold aircon aircon' + count + '" value="" disabled>';
        ...
        if (submitValidation()) {
            ...
            $.ajax({
                ...
                success: function(id) {
                    ...
                    console.log(btnActivateValueArray);
    ...
    function loadNotedBy(dailyroomId) {
        $.ajax({
            url: '../controller/phd_controller/phd_daily_room_inspection_contr.class.php',
            type: 'POST',
            dataType: 'JSON',
    ...
    function btnPreviewDailyRoomPdf(dailyid) {
        strLink = "phd_daily_room_inspection_checklist_pdf.php?d=" + dailyid;
