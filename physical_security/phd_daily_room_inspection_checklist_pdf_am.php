...
FROM phd_dr_inspection_header_am WHERE dailyroomid = :dailyroomid";
...
$categoryArray = array();
$sqlstringcategory = "SELECT dr_rooms,dr_category,dr_aircon_off,dr_lights_off,dr_door_locked,
dr_conv_outlet_unplugged,dr_time_activated,dr_rooms,dr_remarks FROM phd_dr_inspection_details_am
...
if ($main_plant2 == '' and $main_plant3 == '') {
    // $pdf->Image('@' . base64_decode($main_sign), 11, 106, 40, 20, '', '', '', false, 300, '', false, false, 0, false, false, false);
    $pdf->Ln(15);
    ...
    if ($main_plant == $main_plant3) {
        ...
        // $pdf->Image('@' . base64_decode($main_sign2), 11, 106, 40, 20, '', '', '', false, 300, '', false, false, 0, false, false, false);
        $pdf->Ln(15);
