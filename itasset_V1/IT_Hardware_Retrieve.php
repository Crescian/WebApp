            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-3">
                        <select class="form-select fw-bold" id="machine">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>

                    <div class="form-group col-md-12 mb-3">
                        <select class="form-select fw-bold" id="item">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>

                    <div class="form-group col-md-12 mb-3">
                        <input type="text" id="description" class="form-control fw-bold" placeholder="Description:">
                        <div class="invalid-feedback"></div>
                    </div>
...
<script>
    ...
    function loadTableHardwareIssuance(filterValue) {
        tableHardwareIssuance = $('#table_hardware_issuance').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: 'functions/itHardwareIssued.function.php',
                type: 'POST',
                data: {
    ...
    function saveHardwareIssuance() {
        if (formValidation('machine', 'item', 'description', 'issuer')) {
            $.ajax({
                url: 'functions/itHardwareIssued.function.php',
                type: 'POST',
                data: {
    ...
    function formValidation(...args) {
        ...
        let description = $(`#${arguments[2]}`).val();
        ...
        if (description.trim() == '') {
            validate(arguments[2], 'Description is required field.');
            validated = false;
        } else {
